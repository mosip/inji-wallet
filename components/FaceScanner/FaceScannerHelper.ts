...
import {faceToCompare} from "./FaceScanner";
...
export const screenFlashColors = ['#0000FF', '#00FF00', '#FF0000'];
export let predictedColorResults: any[] = new Array();
...
export const cropEyeAreaFromFace = async(picArray, vcImage) => {
