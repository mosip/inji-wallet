...
public class VcDownloadAndVerifyUsingUinTest extends BaseTest {
    ...
    @Test
    public void genrateMultipleVcWithUin() {
    	ChooseLanguagePage chooseLanguagePage = new ChooseLanguagePage(driver);
    ...
    @Test
    public void downloadWithInvalidUin() {
    	ChooseLanguagePage chooseLanguagePage = new ChooseLanguagePage(driver);
        ...
        assertTrue(retrieveIdPage.isRetrieveIdPageLoaded(), "Verify if retrieve id page is displayed");
        OtpVerificationPage otpVerification = retrieveIdPage.setEnterIdTextBox(TestDataReader.readData("invaliduin")).clickOnGenerateCardButton();
        assertTrue(retrieveIdPage.isInvalidUinMassageLoaded(), "Verify if invalid uin massage displayed");
