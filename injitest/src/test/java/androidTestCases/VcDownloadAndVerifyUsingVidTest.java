...
public class VcDownloadAndVerifyUsingVidTest extends AndroidBaseTest {
    ...
    public void verifyInvalidVidErrorMessage() {
        ...
        assertTrue(retrieveIdPage.isRetrieveIdPageLoaded(), "Verify if retrieve id page is displayed");
        OtpVerificationPage otpVerification = retrieveIdPage.clickOnVid(Target.ANDROID).setEnterIdTextBox("6501560247302345").clickOnGenerateCardButton();
    ...
    public void downloadAndVerifyVcUsingRevokeVid() {
        ...
        assertTrue(retrieveIdPage.isRetrieveIdPageLoaded(), "Verify if retrieve id page is displayed");
        OtpVerificationPage otpVerification = retrieveIdPage.clickOnVid(Target.ANDROID).setEnterIdTextBox(TestDataReader.readData("revokevid")).clickOnGenerateCardButton();
