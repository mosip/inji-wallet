...
"done.invoke.issuersMachine.fetchAuthorizationEndpoint:invocation[0]": { type: "done.invoke.issuersMachine.fetchAuthorizationEndpoint:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
...
"error.platform.issuersMachine.fetchAuthorizationEndpoint:invocation[0]": { type: "error.platform.issuersMachine.fetchAuthorizationEndpoint:invocation[0]"; data: unknown };
...
"verifyCredential": "done.invoke.issuersMachine.verifyingCredential:invocation[0]";
        ...
        missingImplementations: {
          actions: "downloadIssuerWellknown" | "loadKeyPair" | "logDownloaded" | "resetError" | "resetLoadingReason" | "resetSelectedCredentialType" | "resetVerificationErrorMessage" | "resetVerificationResult" | "sendBackupEvent" | "sendDownloadingFailedToVcMeta" | "sendErrorEndEvent" | "sendImpressionEvent" | "sendSuccessEndEvent" | "setCredentialTypeListDownloadFailureError" | "setCredentialWrapper" | "setError" | "setIssuers" | "setLoadingReasonAsDisplayIssuers" | "setLoadingReasonAsDownloadingCredentials" | "setLoadingReasonAsSettingUp" | "setMetadataInCredentialData" | "setNetworkOrTechnicalError" | "setNoInternet" | "setOIDCConfigError" | "setPrivateKey" | "setPublicKey" | "setSelectedCredentialType" | "setSelectedIssuerId" | "setSelectedIssuers" | "setSelectedKey" | "setSupportedCredentialTypes" | "setTokenResponse" | "setVCMetadata" | "setVerifiableCredential" | "setVerificationResult" | "storeKeyPair" | "storeVcMetaContext" | "storeVcsContext" | "storeVerifiableCredentialData" | "storeVerifiableCredentialMeta" | "updateAuthorizationEndpoint" | "updateIssuerFromWellknown" | "updateSelectedIssuerWellknownResponse" | "updateVerificationErrorMessage";
          delays: never;
          ...
          services: "checkInternet" | "downloadCredential" | "downloadCredentialTypes" | "downloadIssuerWellknown" | "downloadIssuersList" | "fetchAuthorizationEndpoint" | "generateKeyPair" | "getKeyOrderList" | "getKeyPair" | "getSelectedKey" | "invokeAuthorization" | "isUserSignedAlready" | "verifyCredential";
        };
...
"resetLoadingReason": "RESET_ERROR" | "done.invoke.checkInternet" | "done.invoke.issuersMachine.displayIssuers:invocation[0]" | "error.platform.issuersMachine.downloadCredentialTypes:invocation[0]" | "error.platform.issuersMachine.downloadCredentials:invocation[0]" | "error.platform.issuersMachine.downloadIssuerWellknown:invocation[0]" | "error.platform.issuersMachine.fetchAuthorizationEndpoint:invocation[0]" | "error.platform.issuersMachine.performAuthorization.getKeyPairFromKeystore:invocation[0]" | "error.platform.issuersMachine.performAuthorization.setSelectedKey:invocation[0]" | "error.platform.issuersMachine.performAuthorization:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
...
"sendDownloadingFailedToVcMeta": "error.platform.issuersMachine.downloadCredentials:invocation[0]" | "error.platform.issuersMachine.performAuthorization.getKeyPairFromKeystore:invocation[0]" | "error.platform.issuersMachine.performAuthorization.setSelectedKey:invocation[0]";
...
"setError": "error.platform.issuersMachine.displayIssuers:invocation[0]" | "error.platform.issuersMachine.downloadCredentials:invocation[0]" | "error.platform.issuersMachine.fetchAuthorizationEndpoint:invocation[0]" | "error.platform.issuersMachine.performAuthorization.getKeyPairFromKeystore:invocation[0]" | "error.platform.issuersMachine.performAuthorization.setSelectedKey:invocation[0]";
...
"setLoadingReasonAsSettingUp": "RESET_ERROR" | "SELECTED_ISSUER" | "TRY_AGAIN" | "done.invoke.issuersMachine.performAuthorization:invocation[0]";
...
"setNetworkOrTechnicalError": "error.platform.issuersMachine.downloadIssuerWellknown:invocation[0]" | "error.platform.issuersMachine.performAuthorization:invocation[0]";
...
"downloadCredentialTypes": "done.invoke.issuersMachine.fetchAuthorizationEndpoint:invocation[0]";
"downloadIssuerWellknown": "SELECTED_ISSUER" | "TRY_AGAIN";
"downloadIssuersList": "CANCEL" | "TRY_AGAIN" | "xstate.init";
"fetchAuthorizationEndpoint": "done.invoke.issuersMachine.downloadIssuerWellknown:invocation[0]";
