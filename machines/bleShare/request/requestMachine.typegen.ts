...
"verifyVp": "done.invoke.request.reviewing.verifyingVp:invocation[0]";
        ...
        eventsCausingActions: {
          "clearShouldVerifyPresence": "ACCEPT" | "BLE_ERROR" | "CANCEL" | "FACE_INVALID" | "FACE_VALID" | "REJECT" | "RESET" | "SCREEN_BLUR" | "SCREEN_FOCUS" | "xstate.stop";
"logReceived": "CANCEL" | "REJECT" | "STORE_ERROR" | "STORE_RESPONSE";
"openAppPermission": "GOTO_SETTINGS";
"prependReceivedVcMetadata": "ACCEPT" | "DISMISS" | "FACE_VALID" | "VC_RECEIVED" | "done.invoke.request.reviewing.verifyingVp:invocation[0]";
...
"reviewing"?: "accepted" | "accepting" | "displayingIncomingVC" | "idle" | "invalidIdentity" | "navigatingToHistory" | "navigatingToHome" | "navigatingToReceivedCards" | "rejected" | "savingFailed" | "verifyingIdentity" | "verifyingVp" | { "accepting"?: "prependingReceivedVcMetadata" | "storingVc";
