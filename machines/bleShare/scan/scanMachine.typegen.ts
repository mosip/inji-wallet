...
"SHARING_TIMEOUT": "ACCEPT_REQUEST" | "FACE_VALID" | "done.invoke.scan.reviewing.creatingVp:invocation[0]";
        ...
        eventsCausingGuards: {
          "isConsentGiven": "VERIFY_AND_ACCEPT_REQUEST";
...
"reviewing"?: "accepted" | "cancelling" | "creatingVp" | "disconnect" | "faceVerificationConsent" | "invalidIdentity" | "navigateToHistory" | "rejected" | "selectingVc" | "sendingVc" | "verifyingIdentity" | { "sendingVc"?: "inProgress" | "sent" | "timeout"; };
