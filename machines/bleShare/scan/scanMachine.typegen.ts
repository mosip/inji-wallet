...
"startConnection": "done.invoke.scan.connecting:invocation[0]";
        ...
        eventsCausingActions: {
          "clearCreatedVp": "" | "BLE_ERROR" | "DISCONNECT" | "RESET" | "RETRY" | "SCREEN_BLUR" | "SCREEN_FOCUS" | "SELECT_VC" | "xstate.stop";
...
"SHARING_TIMEOUT": "ACCEPT_REQUEST" | "CHECK_FLOW_TYPE" | "FACE_VALID" | "done.invoke.scan.reviewing.creatingVp:invocation[0]";
        };
        eventsCausingGuards: {
...
"reviewing"?: "accepted" | "cancelling" | "creatingVp" | "disconnect" | "faceVerificationConsent" | "idle" | "invalidIdentity" | "navigateToHistory" | "rejected" | "selectingVc" | "sendingVc" | "verifyingIdentity" | { "sendingVc"?: "inProgress" | "sent" | "timeout"; };
