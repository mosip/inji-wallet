...
"storeContext": "CREDENTIAL_DOWNLOADED" | "done.invoke.vc-item.verifyingCredential:invocation[0]";
...
"verifyCredential": "" | "VERIFY";
        ...
        matchesStates: "acceptingOtpInput" | "acceptingRevokeInput" | "checkingServerData" | "checkingServerData.checkingStatus" | "checkingServerData.downloadingCredential" | "checkingStore" | "checkingVc" | "checkingVerificationStatus" | "editingTag" | "idle" | "invalid" | "invalid.backend" | "invalid.otp" | "lockingVc" | "loggingRevoke" | "requestingLock" | "requestingOtp" | "requestingRevoke" | "revokingVc" | "storingTag" | "verifyingCredential" | { "checkingServerData"?: "checkingStatus" | "downloadingCredential";
"invalid"?: "backend" | "otp"; };
        tags: never;
      }
