  ...
  export interface Typegen0 {
        '@@xstate/typegen': true;
        internalEvents: {
          "done.invoke.backupAndRestoreSetup.checkInternet:invocation[0]": { type: "done.invoke.backupAndRestoreSetup.checkInternet:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
...
"unsetIsLoading": "DISMISS" | "STORE_RESPONSE" | "done.invoke.backupAndRestoreSetup.checkSignIn:invocation[0]";
...
"signIn": "done.invoke.backupAndRestoreSetup.checkInternet:invocation[0]" | "done.invoke.backupAndRestoreSetup.checkSignIn:invocation[0]";
        };
        matchesStates: "backupAndRestore" | "checkInternet" | "checkSignIn" | "checkSignIn.error" | "checkSignIn.idle" | "fetchShowConfirmationInfo" | "init" | "noInternet" | "selectCloudAccount" | "signIn" | "signIn.error" | "signIn.idle" | { "checkSignIn"?: "error" | "idle";
"signIn"?: "error" | "idle"; };
        tags: never;
      }
