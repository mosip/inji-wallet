...
"done.invoke.vc-item.checkingServerData.loadDownloadLimitConfig:invocation[0]": { type: "done.invoke.vc-item.checkingServerData.loadDownloadLimitConfig:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
...
"done.invoke.vc-item.kebabPopUp.removingVc.triggerAutoBackup:invocation[0]": { type: "done.invoke.vc-item.kebabPopUp.removingVc.triggerAutoBackup:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
...
"done.invoke.vc-item.verifyingCredential.triggerAutoBackupForVcDownload:invocation[0]": { type: "done.invoke.vc-item.verifyingCredential.triggerAutoBackupForVcDownload:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
...
"error.platform.vc-item.acceptingBindingOtp.resendOTP:invocation[0]": { type: "error.platform.vc-item.acceptingBindingOtp.resendOTP:invocation[0]"; data: unknown };
...
"isUserSignedAlready": "done.invoke.vc-item.kebabPopUp.removingVc.triggerAutoBackup:invocation[0]" | "done.invoke.vc-item.verifyingCredential.triggerAutoBackupForVcDownload:invocation[0]";
"loadDownloadLimitConfig": "done.invoke.vc-item.checkingServerData.loadDownloadLimitConfig:invocation[0]";
"requestBindingOtp": "done.invoke.vc-item.acceptingBindingOtp.resendOTP:invocation[0]" | "done.invoke.vc-item.requestingBindingOtp:invocation[0]";
...
"clearOtp": "" | "CANCEL" | "DISMISS" | "GET_VC_RESPONSE" | "REVOKE_VC" | "SHOW_BINDING_STATUS" | "STORE_RESPONSE" | "done.invoke.vc-item.requestingBindingOtp:invocation[0]" | "done.invoke.vc-item.requestingOtp:invocation[0]" | "done.invoke.vc-item.verifyingCredential.triggerAutoBackupForVcDownload:invocation[0]" | "error.platform.vc-item.requestingLock:invocation[0]" | "error.platform.vc-item.requestingRevoke:invocation[0]";
"clearTransactionId": "" | "CANCEL" | "DISMISS" | "GET_VC_RESPONSE" | "SHOW_BINDING_STATUS" | "STORE_RESPONSE" | "done.invoke.vc-item.verifyingCredential.triggerAutoBackupForVcDownload:invocation[0]";
"incrementDownloadCounter": "POLL" | "done.invoke.vc-item.checkingServerData.loadDownloadLimitConfig:invocation[0]";
...
"logWalletBindingSuccess": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
...
"removeVcMetaDataFromStorage": "STORE_ERROR" | "error.platform.vc-item.verifyingCredential:invocation[0]";
...
"sendActivationFailedEndEvent": "DISMISS" | "error.platform.vc-item.updatingPrivateKey:invocation[0]";
"sendActivationStartEvent": "CONFIRM";
"sendActivationSuccessEvent": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
"sendBackupEvent": "done.invoke.vc-item.kebabPopUp.removingVc.triggerAutoBackup:invocation[0]" | "done.invoke.vc-item.verifyingCredential.triggerAutoBackupForVcDownload:invocation[0]";
...
"setThumbprintForWalletBindingId": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
...
"setWalletBindingError": "error.platform.vc-item.acceptingBindingOtp.resendOTP:invocation[0]" | "error.platform.vc-item.addKeyPair:invocation[0]" | "error.platform.vc-item.addingWalletBindingId:invocation[0]" | "error.platform.vc-item.requestingBindingOtp:invocation[0]" | "error.platform.vc-item.updatingPrivateKey:invocation[0]";
"setWalletBindingErrorEmpty": "CANCEL" | "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
"setWalletBindingId": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
"storeContext": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.verifyingCredential:invocation[0]";
"storeLock": "done.invoke.vc-item.requestingLock:invocation[0]";
"updatePrivateKey": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
"updateVc": "STORE_RESPONSE" | "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
...
"isCustomSecureKeystore": "done.invoke.vc-item.addKeyPair:invocation[0]" | "done.invoke.vc-item.addingWalletBindingId:invocation[0]";
"isDownloadAllowed": "POLL";
"isSignedIn": "done.invoke.vc-item.kebabPopUp.removingVc.triggerAutoBackup:invocation[0]" | "done.invoke.vc-item.verifyingCredential.triggerAutoBackupForVcDownload:invocation[0]";
        };
        eventsCausingServices: {
          "addWalletBindnigId": "done.invoke.vc-item.addKeyPair:invocation[0]";
"checkDownloadExpiryLimit": "POLL" | "done.invoke.vc-item.checkingServerData.loadDownloadLimitConfig:invocation[0]";
...
"checkingServerData"?: "checkingStatus" | "downloadingCredential" | "loadDownloadLimitConfig" | "savingFailed" | "verifyingDownloadLimitExpiry" | { "savingFailed"?: "idle" | "viewingVc"; };
"invalid"?: "backend" | "otp";
"kebabPopUp"?: "idle" | "removeWallet" | "removingVc" | "showActivities" | { "removingVc"?: "triggerAutoBackup"; };
