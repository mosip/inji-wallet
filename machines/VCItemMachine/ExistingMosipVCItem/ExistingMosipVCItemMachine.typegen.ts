...
"done.invoke.vc-item.kebabPopUp.addKeyPair:invocation[0]": { type: "done.invoke.vc-item.kebabPopUp.addKeyPair:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]": { type: "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"done.invoke.vc-item.kebabPopUp.requestingBindingOtp:invocation[0]": { type: "done.invoke.vc-item.kebabPopUp.requestingBindingOtp:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]": { type: "done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
...
"error.platform.vc-item.kebabPopUp.addKeyPair:invocation[0]": { type: "error.platform.vc-item.kebabPopUp.addKeyPair:invocation[0]"; data: unknown };
"error.platform.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]": { type: "error.platform.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]"; data: unknown };
"error.platform.vc-item.kebabPopUp.requestingBindingOtp:invocation[0]": { type: "error.platform.vc-item.kebabPopUp.requestingBindingOtp:invocation[0]"; data: unknown };
"error.platform.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]": { type: "error.platform.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]"; data: unknown };
...
"xstate.init": { type: "xstate.init" };
        ...
        invokeSrcNameMap: {
          "addWalletBindnigId": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]";
...
"generateKeyPair": "done.invoke.vc-item.addKeyPair:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addKeyPair:invocation[0]";
"requestBindingOtp": "done.invoke.vc-item.kebabPopUp.requestingBindingOtp:invocation[0]" | "done.invoke.vc-item.requestingBindingOtp:invocation[0]";
"requestLock": "done.invoke.vc-item.requestingLock:invocation[0]";
"requestOtp": "done.invoke.vc-item.acceptingOtpInput.resendOTP:invocation[0]" | "done.invoke.vc-item.requestingOtp:invocation[0]";
"requestRevoke": "done.invoke.vc-item.requestingRevoke:invocation[0]";
"updatePrivateKey": "done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
...
"clearTransactionId": "" | "CANCEL" | "DISMISS" | "STORE_RESPONSE" | "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.verifyingCredential:invocation[0]" | "error.platform.vc-item.verifyingCredential:invocation[0]";
"incrementDownloadCounter": "POLL";
"logDownloaded": "STORE_RESPONSE";
"logRevoked": "STORE_RESPONSE";
"logVCremoved": "STORE_RESPONSE";
"logWalletBindingFailure": "error.platform.vc-item.addKeyPair:invocation[0]" | "error.platform.vc-item.addingWalletBindingId:invocation[0]" | "error.platform.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]" | "error.platform.vc-item.requestingBindingOtp:invocation[0]" | "error.platform.vc-item.updatingPrivateKey:invocation[0]";
"logWalletBindingSuccess": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
...
"sendActivationSuccessEvent": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
"sendDownloadLimitExpire": "FAILED" | "error.platform.vc-item.checkingServerData.verifyingDownloadLimitExpiry:invocation[0]";
"sendTamperedVc": "TAMPERED_VC";
"sendTelemetryEvents": "STORE_RESPONSE";
"sendVcUpdated": "PIN_CARD";
"sendWalletBindingSuccess": "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]";
...
"setPinCard": "PIN_CARD";
"setPrivateKey": "done.invoke.vc-item.addKeyPair:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addKeyPair:invocation[0]";
"setPublicKey": "done.invoke.vc-item.addKeyPair:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addKeyPair:invocation[0]";
"setRevoke": "done.invoke.vc-item.requestingRevoke:invocation[0]";
"setStoreVerifiableCredential": "CREDENTIAL_DOWNLOADED";
"setThumbprintForWalletBindingId": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]";
...
"setWalletBindingError": "error.platform.vc-item.addKeyPair:invocation[0]" | "error.platform.vc-item.addingWalletBindingId:invocation[0]" | "error.platform.vc-item.kebabPopUp.addKeyPair:invocation[0]" | "error.platform.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]" | "error.platform.vc-item.kebabPopUp.requestingBindingOtp:invocation[0]" | "error.platform.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]" | "error.platform.vc-item.requestingBindingOtp:invocation[0]" | "error.platform.vc-item.updatingPrivateKey:invocation[0]";
"setWalletBindingErrorEmpty": "CANCEL" | "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
"setWalletBindingId": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]";
"setWalletBindingSuccess": "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
"storeContext": "CREDENTIAL_DOWNLOADED" | "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.verifyingCredential:invocation[0]";
"storeLock": "done.invoke.vc-item.requestingLock:invocation[0]";
"updatePrivateKey": "done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]";
"updateVc": "STORE_RESPONSE" | "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.updatingPrivateKey:invocation[0]" | "done.invoke.vc-item.verifyingCredential:invocation[0]";
        };
        eventsCausingDelays: {
...
"isCustomSecureKeystore": "done.invoke.vc-item.addKeyPair:invocation[0]" | "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addKeyPair:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]";
"isDownloadAllowed": "POLL";
"isVcValid": "";
        };
        eventsCausingServices: {
          "addWalletBindnigId": "done.invoke.vc-item.addKeyPair:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addKeyPair:invocation[0]";
"checkDownloadExpiryLimit": "POLL" | "STORE_RESPONSE";
...
"updatePrivateKey": "done.invoke.vc-item.addingWalletBindingId:invocation[0]" | "done.invoke.vc-item.kebabPopUp.addingWalletBindingId:invocation[0]";
...
"checkingServerData"?: "checkingStatus" | "downloadingCredential" | "savingFailed" | "verifyingDownloadLimitExpiry" | { "savingFailed"?: "idle" | "viewingVc"; };
"invalid"?: "backend" | "otp";
"kebabPopUp"?: "acceptingBindingOtp" | "addKeyPair" | "addingWalletBindingId" | "idle" | "removeWallet" | "removingVc" | "requestingBindingOtp" | "showActivities" | "showBindingWarning" | "showingWalletBindingError" | "updatingPrivateKey"; };
        tags: never;
      }
