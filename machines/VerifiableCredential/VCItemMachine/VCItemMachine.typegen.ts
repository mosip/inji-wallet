...
export interface Typegen0 {
  ...
  internalEvents: {
    ...
    'done.invoke.vc-item-machine.vcUtilitiesState.walletBinding.generateKeyPair:invocation[0]': {
      type: 'done.invoke.vc-item-machine.vcUtilitiesState.walletBinding.generateKeyPair:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    ...
    'error.platform.vc-item-machine.vcUtilitiesState.walletBinding.generateKeyPair:invocation[0]': {
      type: 'error.platform.vc-item-machine.vcUtilitiesState.walletBinding.generateKeyPair:invocation[0]';
      data: unknown;
    };
  ...
  invokeSrcNameMap: {
    ...
    fetchKeyPair: 'done.invoke.vc-item-machine.vcUtilitiesState.walletBinding.addKeyPair:invocation[0]';
    generateKeypairAndStore: 'done.invoke.vc-item-machine.vcUtilitiesState.walletBinding.generateKeyPair:invocation[0]';
    isUserSignedAlready:
      | 'done.invoke.vc-item-machine.vcUtilitiesState.kebabPopUp.triggerAutoBackup:invocation[0]'
      | 'done.invoke.vc-item-machine.vcUtilitiesState.verifyingCredential.triggerAutoBackupForVcDownload:invocation[0]';
  ...
  eventsCausingActions: {
    ...
    setOTP: 'INPUT_OTP';
    setPinCard: 'PIN_CARD';
    setPrivateKey: 'done.invoke.vc-item-machine.vcUtilitiesState.walletBinding.generateKeyPair:invocation[0]';
    setPublicKey:
      | 'done.invoke.vc-item-machine.vcUtilitiesState.walletBinding.addKeyPair:invocation[0]'
      | 'done.invoke.vc-item-machine.vcUtilitiesState.walletBinding.generateKeyPair:invocation[0]';
    setThumbprintForWalletBindingId:
  ...
  eventsCausingServices: {
    ...
    fetchKeyPair: 'INPUT_OTP';
    generateKeypairAndStore: 'done.invoke.vc-item-machine.vcUtilitiesState.walletBinding.addKeyPair:invocation[0]';
