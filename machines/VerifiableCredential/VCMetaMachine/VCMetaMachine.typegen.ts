...
"loadMyVcsMetadata": "DOWNLOAD_LIMIT_EXPIRED" | "REFRESH_MY_VCS" | "REFRESH_RECEIVED_VCS" | "STORE_RESPONSE" | "VERIFY_VC_FAILED" | "xstate.init";
...
"isSignedIn": "done.invoke.vcMeta.ready.tamperedVCs.triggerAutoBackupForTamperedVcDeletion:invocation[0]";
        ...
        matchesStates: "deletingFailedVcs" | "ready" | "ready.myVcsData" | "ready.myVcsMetadata" | "ready.receivedVcs" | "ready.receivedVcsMetadata" | "ready.showTamperedPopup" | "ready.tamperedVCs" | "ready.tamperedVCs.idle" | "ready.tamperedVCs.triggerAutoBackupForTamperedVcDeletion" | { "ready"?: "myVcsData" | "myVcsMetadata" | "receivedVcs" | "receivedVcsMetadata" | "showTamperedPopup" | "tamperedVCs" | { "tamperedVCs"?: "idle" | "triggerAutoBackupForTamperedVcDeletion"; }; };
        tags: never;
      }
