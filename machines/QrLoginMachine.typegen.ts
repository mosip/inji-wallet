...
"sendConsent": "done.invoke.QrLogin.sendingConsent:invocation[0]";
        ...
        eventsCausingActions: {
          "SetErrorMessage": "error.platform.QrLogin.linkTransaction:invocation[0]" | "error.platform.QrLogin.sendingConsent:invocation[0]";
...
"sendConsent": "CONFIRM";
        ...
        matchesStates: "ShowError" | "done" | "faceAuth" | "invalidIdentity" | "linkTransaction" | "loadMyVcs" | "requestConsent" | "sendingConsent" | "showWarning" | "showvcList" | "success" | "waitingForData";
        tags: never;
      }
