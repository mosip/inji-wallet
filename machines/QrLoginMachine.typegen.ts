...
"error.platform.QrLogin.requestingConsent:invocation[0]": { type: "error.platform.QrLogin.requestingConsent:invocation[0]"; data: unknown };
...
"sendConsent": "done.invoke.QrLogin.requestingConsent:invocation[0]";
        ...
        eventsCausingActions: {
          "SetErrorMessage": "error.platform.QrLogin.linkTransaction:invocation[0]" | "error.platform.QrLogin.requestingConsent:invocation[0]";
...
"sendConsent": "CONFIRM";
        ...
        matchesStates: "ShowError" | "done" | "faceAuth" | "invalidIdentity" | "linkTransaction" | "loadMyVcs" | "requestConsent" | "requestingConsent" | "showWarning" | "showvcList" | "success" | "waitingForData";
        tags: never;
      }
