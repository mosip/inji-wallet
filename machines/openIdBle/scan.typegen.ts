...
"clearScannedQrParams": "CONNECTION_DESTROYED" | "DISCONNECT" | "DISMISS" | "xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling";
...
"registerLoggers": "CONNECTION_DESTROYED" | "DISCONNECT" | "DISMISS" | "xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling";
"removeLoggers": "CONNECTION_DESTROYED" | "DISCONNECT" | "DISMISS" | "SCREEN_BLUR" | "xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling" | "xstate.init";
...
"sendVc": "ACCEPT_REQUEST" | "FACE_VALID" | "done.invoke.scan.reviewing.creatingVp:invocation[0]";
        ...
        matchesStates: "bluetoothDenied" | "checkingBluetoothService" | "checkingBluetoothService.checking" | "checkingBluetoothService.enabled" | "checkingBluetoothService.requesting" | "checkingLocationService" | "checkingLocationService.checkingPermission" | "checkingLocationService.checkingStatus" | "checkingLocationService.denied" | "checkingLocationService.disabled" | "checkingLocationService.requestingToEnable" | "clearingConnection" | "connecting" | "connecting.inProgress" | "connecting.timeout" | "disconnected" | "exchangingDeviceInfo" | "exchangingDeviceInfo.inProgress" | "exchangingDeviceInfo.timeout" | "findingConnection" | "inactive" | "invalid" | "preparingToConnect" | "reviewing" | "reviewing.accepted" | "reviewing.cancelling" | "reviewing.creatingVp" | "reviewing.invalidIdentity" | "reviewing.navigatingToHome" | "reviewing.rejected" | "reviewing.selectingVc" | "reviewing.sendingVc" | "reviewing.sendingVc.inProgress" | "reviewing.sendingVc.timeout" | "reviewing.verifyingIdentity" | { "checkingBluetoothService"?: "checking" | "enabled" | "requesting";
"checkingLocationService"?: "checkingPermission" | "checkingStatus" | "denied" | "disabled" | "requestingToEnable";
"connecting"?: "inProgress" | "timeout";
"exchangingDeviceInfo"?: "inProgress" | "timeout";
"reviewing"?: "accepted" | "cancelling" | "creatingVp" | "invalidIdentity" | "navigatingToHome" | "rejected" | "selectingVc" | "sendingVc" | "verifyingIdentity" | { "sendingVc"?: "inProgress" | "timeout"; }; };
        tags: never;
      }
