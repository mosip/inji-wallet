...
export interface Typegen0 {
    '@@xstate/typegen': true;
    internalEvents: {
        "done.invoke.backupRestore.preload:invocation[0]": { type: "done.invoke.backupRestore.preload:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
        ...
        "done.invoke.backupRestore.restoreBackup.deleteBackupDir:invocation[0]": { type: "done.invoke.backupRestore.restoreBackup.deleteBackupDir:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
    ...
    eventsCausingActions: {
        ...
        "sendDataRestoreFailureEvent": "STORE_ERROR" | "done.invoke.backupRestore.restoreBackup.checkStorageAvailability:invocation[0]" | "error.platform.backupRestore.restoreBackup.downloadBackupFileFromCloud:invocation[0]" | "error.platform.backupRestore.restoreBackup.unzipBackupFile:invocation[0]";
        "sendDataRestoreStartEvent": "BACKUP_RESTORE" | "EXTRACT_DATA" | "done.invoke.backupRestore.preload:invocation[0]";
    ...
    eventsCausingServices: {
        ...
        "checkStorageAvailability": "BACKUP_RESTORE" | "EXTRACT_DATA" | "done.invoke.backupRestore.preload:invocation[0]";
        ...
        "readBackupFile": "done.invoke.backupRestore.preload:invocation[0]" | "done.invoke.backupRestore.restoreBackup.unzipBackupFile:invocation[0]";
        "unzipBackupFile": "done.invoke.backupRestore.restoreBackup.downloadBackupFileFromCloud:invocation[0]";
    };
    matchesStates: "init" | "preload" | "restoreBackup" | "restoreBackup.checkStorageAvailability" | "restoreBackup.deleteBackupDir" | "restoreBackup.downloadBackupFileFromCloud" | "restoreBackup.failure" | "restoreBackup.idle" | "restoreBackup.loadDataToMemory" | "restoreBackup.readBackupFile" | "restoreBackup.success" | "restoreBackup.unzipBackupFile" | { "restoreBackup"?: "checkStorageAvailability" | "deleteBackupDir" | "downloadBackupFileFromCloud" | "failure" | "idle" | "loadDataToMemory" | "readBackupFile" | "success" | "unzipBackupFile"; };
    tags: never;
}
