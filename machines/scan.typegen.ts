...
"error.platform.scan.reviewing.creatingVp:invocation[0]": { type: "error.platform.scan.reviewing.creatingVp:invocation[0]"; data: unknown };
"xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling": { type: "xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling" };
"xstate.after(CLEAR_DELAY)#scan.clearingConnection": { type: "xstate.after(CLEAR_DELAY)#scan.clearingConnection" };
...
"xstate.after(SHARING_TIMEOUT)#scan.reviewing.sendingVc.inProgress": { type: "xstate.after(SHARING_TIMEOUT)#scan.reviewing.sendingVc.inProgress" };
...
"clearScannedQrParams": "DISCONNECT" | "DISMISS" | "xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling" | "xstate.after(CLEAR_DELAY)#scan.clearingConnection";
"disconnect": "DISCONNECT" | "DISMISS" | "LOCATION_ENABLED" | "SCREEN_BLUR" | "SCREEN_FOCUS" | "xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling" | "xstate.stop";
"logFailedVerification": "FACE_INVALID";
"logShared": "VC_ACCEPTED";
"onlineUnsubscribe": "ACCEPT_REQUEST" | "CANCEL" | "DISCONNECT" | "SCREEN_BLUR" | "SCREEN_FOCUS" | "VERIFY_AND_ACCEPT_REQUEST" | "xstate.stop";
"openSettings": "LOCATION_REQUEST";
"registerLoggers": "DISCONNECT" | "DISMISS" | "xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling" | "xstate.after(CLEAR_DELAY)#scan.clearingConnection";
"removeLoggers": "DISCONNECT" | "DISMISS" | "SCREEN_BLUR" | "xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling" | "xstate.after(CLEAR_DELAY)#scan.clearingConnection" | "xstate.init";
...
"sendScanData": "SCAN";
"setChildRef": "DISCONNECT" | "DISMISS" | "xstate.after(CANCEL_TIMEOUT)#scan.reviewing.cancelling" | "xstate.after(CLEAR_DELAY)#scan.clearingConnection";
...
"SHARING_TIMEOUT": "ACCEPT_REQUEST" | "FACE_VALID" | "VC_SENT" | "done.invoke.scan.reviewing.creatingVp:invocation[0]";
        };
        eventsCausingGuards: {
          "isQrLogin": "SCAN";
"isQrOffline": "SCAN";
...
"monitorCancellation": "CANCEL" | "DISMISS" | "EXCHANGE_DONE" | "error.platform.scan.reviewing.creatingVp:invocation[0]";
"monitorConnection": "xstate.init";
"sendDisconnect": "CANCEL";
"sendVc": "ACCEPT_REQUEST" | "FACE_VALID" | "VC_SENT" | "done.invoke.scan.reviewing.creatingVp:invocation[0]";
        };
        matchesStates: "checkingLocationService" | "checkingLocationService.checkingPermission" | "checkingLocationService.checkingStatus" | "checkingLocationService.denied" | "checkingLocationService.disabled" | "checkingLocationService.requestingToEnable" | "checkingNetwork" | "clearingConnection" | "connecting" | "connecting.inProgress" | "connecting.timeout" | "disconnected" | "exchangingDeviceInfo" | "exchangingDeviceInfo.inProgress" | "exchangingDeviceInfo.timeout" | "findingConnection" | "inactive" | "invalid" | "offline" | "preparingToConnect" | "reviewing" | "reviewing.accepted" | "reviewing.cancelling" | "reviewing.creatingVp" | "reviewing.invalidIdentity" | "reviewing.navigatingToHome" | "reviewing.rejected" | "reviewing.selectingVc" | "reviewing.sendingVc" | "reviewing.sendingVc.inProgress" | "reviewing.sendingVc.sent" | "reviewing.sendingVc.timeout" | "reviewing.verifyingIdentity" | "showQrLogin" | "showQrLogin.idle" | "showQrLogin.navigatingToHome" | "showQrLogin.storing" | { "checkingLocationService"?: "checkingPermission" | "checkingStatus" | "denied" | "disabled" | "requestingToEnable";
