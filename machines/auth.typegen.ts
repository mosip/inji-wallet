...
"storeContext": "SETUP_BIOMETRICS" | "SETUP_PASSCODE" | "STORE_RESPONSE" | "done.invoke.auth.authorized:invocation[0]";
        };
        eventsCausingDelays: {
...
"isSplashShowed": "";
        ...
        matchesStates: "authorized" | "checkingAuth" | "init" | "introSlider" | "languagesetup" | "savingDefaults" | "settingUp" | "splashScreen" | "unauthorized";
        tags: never;
      }
